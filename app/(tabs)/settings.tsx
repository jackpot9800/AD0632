...
export default function SettingsScreen() {
    ...
    try {
      ...
      const response = await fetch(`${finalUrl}/version`, {
        ...
        headers: {
          ...
          'User-Agent': 'PresentationKiosk/2.4.0 (FireTV)',
  ...
  const saveSettings = async () => {
    ...
    try {
      console.log('=== SAVING SETTINGS v2.4.0 ===');
  ...
  const registerDevice = async () => {
    ...
    try {
      console.log('=== MANUAL DEVICE REGISTRATION v2.4.0 ===');
    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Version 2.4.0 - DEBUG COMPLET</Text>
        </View>
          ...
          <View style={styles.infoCard}>
            <View style={styles.infoRow}>
              ...
              <View style={styles.infoContent}>
                ...
                <Text style={styles.infoValue}>2.4.0 - DEBUG COMPLET</Text>
              </View>
            </View>
